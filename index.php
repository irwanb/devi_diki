...
<head>
	...
	<title>The Wedding of Devi & Diki</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="The Wedding of Devi & Diki" />
	<meta name="keywords" content="wedding, wedding invitation, invitation, the wedding" />
	<meta name="author" content="Devi & Diki" />
	...
	<div id="floating-button" class="float">
		<div class="control-center open">
			<div class="audio-play">
				<div data-video="Sv8XHiTkDYg" data-autoplay="1" data-loop="2" id="youtube-audio1"></div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						...
						<p style="margin-bottom: 0">Bapak/Ibu/Saudara/i</p>
						<p style="margin-bottom: 0; font-size: 45px">Si Bejo</p>
						<p>di tempat</p>

						<button class="btn btn-primary" id="open-invitation">Buka Undangan <i class="icon-book"></i></button>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-header">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h1>Devi & Diki</h1>
					<p style="color: #bf9b73; margin-bottom: 0">Kami akan menikah,</p>
					<p style="color: #bf9b73; margin-bottom: 0">dan kami ingin Anda menjadi bagian dari</p>
					<p style="color: #bf9b73; margin-bottom: 0">hari istimewa kami!</p>
					<div class="simply-countdown simply-countdown-wedding"></div>
					<p>
						<i style="color: #bf9b73; font-size: 20px">Kamis, 24 April 2023</i></br></br>
						<a href="https://calendar.google.com/event?action=TEMPLATE&tmeid=NW0zY2Ewam91bnUzbW5ub2YwdjVxaTliNmUgcDY4MjI3cmY0dTJ0cWI1b3JrZjEwbTN1NDRAZw&tmsrc=p68227rf4u2tqb5orkf10m3u44%40group.calendar.google.com" target="_blank" class="btn btn-primary btn-sm">Save the date</a>
					</p>
				</div>
			</div>
		</div>
				...
				<div class="couple-half">
					...
					<div class="desc-groom">
						...
						<p><span style="color: #bf9b73">Putri Pertama dari</span><br>
							<span class="parents-font">Bapak Muhammad Sholeh</span>
							<br>
							<span class="parents-font">Ibu Nur Alifah (almh)</span>
						</p>
						<div id="social-media-rehan">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://www.instagram.com/deviainurr/"><i class="icon-instagram-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.facebook.com/devi.rosida.7/"><i class="icon-facebook-with-circle"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="couple-half">
					...
					<div class="desc-bride">
						...
						<p><span style="color: #bf9b73">Putra Kedua dari</span><br>
							<span class="parents-font">Bapak Purdianto</span>
							<br>
							<span class="parents-font">Ibu Naning Tri Mahariani</span>
						</p>
						<div id="social-media-molid">
							<ul class="fh5co-social-icons">
								...
								<li><a target="_blank" href="https://www.instagram.com/dikis44/"><i class="icon-instagram-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.facebook.com/septian.diki/"><i class="icon-facebook-with-circle"></i></a></li>
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<div class="event-col">
								...
								<span>Minggu</span>
								<span class="tanggal">23 April 2023</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat : Kauman 3/04 RT.005 RW.001 Mojoagung, Jombang - Jawa Timur</p>

							<a href="https://goo.gl/maps/C5HSqvf6Rp7bAmL89" target="_blank"
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<div class="event-col">
								<i class="icon-calendar"></i>
								<span>Kamis</span>
								<span class="tanggal">27 April 2023</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat : Kauman 3/04 RT.005 RW.001 Mojoagung, Jombang - Jawa Timur</p>
	...
	<div id="fh5co-gallery" style="background: url('images/background/repeat-background/so-white.png'); background-repeat:repeat ">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2>Galeri Foto</h2>
					<h3 style="color: #bf9b73">Gallery Of Devi & Diki</h3>
				</div>
			</div>
	...
	<!-- <div id="fh5co-testimonial" style="background: url('images/background/repeat-background/so-white.png'); background-repeat:repeat; border-top: 1px solid #f2f2f2">
		...
		<div class="container">
			...
			<div id="button-send" class="text-center animate-box">
				<input value="Kirim Ucapan" class="btn btn-primary btn-sm"></input><br>
			</div>
		</div>
	</div> -->
							...
							<form action="post.php" method="post">
								<!-- <table width="100%" border="0">
									<tr><td>
										...
										<tr><td>
											<input class="alamat" name="alamat" type="text" id="TxtAlamat" size="42" placeholder="Alamat"></td></tr>
										<tr><td><textarea name="pesan" placeholder="Pesan Anda"></textarea></td></tr>
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<ul class="fh5co-social-icons">
						...
						<li><a target="_blank" href="https://www.instagram.com/deviainurr/"><i class="icon-instagram"></i></a></li>
						<li><a target="_blank" href="https://www.facebook.com/devi.rosida.7/"><i class="icon-facebook"></i></a></li>
						<!-- <li><a target="_blank" href="https://twitter.com/ngodingsolusi"><i class="icon-twitter"></i></a></li> -->
					</ul>
					</p>
				</div>
			</div>
